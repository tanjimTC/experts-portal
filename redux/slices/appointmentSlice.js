...
const appointmentSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(getAppointmentByEmail.fulfilled, (state, action) => {
      state.allAppointment = action.payload;
      state.loading = false;
    });

    builder.addCase(getAppointmentByClientEmail.fulfilled, (state, action) => {
      state.allAppointmentCleint = action.payload;
      state.loading = false;
    });

    builder.addCase(getRequstedAppointmentByEmail.fulfilled, (state, action) => {
      state.allPhysicalAppointment = action.payload;
      state.loading = false;
    });

    builder.addCase(getRequstedAppointmentByClientEmail.fulfilled, (state, action) => {
